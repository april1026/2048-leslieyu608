...
void table() { 
    cout << "שÝשששששששששששששששÞשששששששששששששששÞשששששששששששששששÞשששששששששששששששß" << endl;
    for (int i = 0; i < 4; i++) {
        for (int j = 0; j < 3; j++) {
            cout << "שר       שר       שר       שר       שר" << endl;
        }
        if (i == 3) {
            cout << "שדשששששששששששששששהשששששששששששששששהשששששששששששששששהשששששששששששששששו" << endl;
        } else {
            cout << "שאשששששששששששששששבשששששששששששששששבשששששששששששששששבשששששששששששששששג" << endl;
        }
    }
}
